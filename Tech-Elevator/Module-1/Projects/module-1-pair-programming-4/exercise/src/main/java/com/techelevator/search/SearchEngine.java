...
public class SearchEngine {
	...
	public Map<Integer,String> listOfFilesWithIndex  = new HashMap<>();
	...
	public void setListOfFilesWithIndex(Map<Integer, String> listOfFilesWithIndex) {
		this.listOfFilesWithIndex = listOfFilesWithIndex;
	}

	public Map<Integer, String> getListOfFilesWithIndex() {
		return listOfFilesWithIndex;
	}
	...
	public void indexFiles() throws SearchEngineException, Exception {
		...
		try {
			...
			for (String file : files) {
				File dataFile = new File(System.getProperty("user.dir") + "\\exercise\\"+file);
				System.out.println(System.getProperty("user.dir") + "\\exercise\\data\\"+file);
				if (!dataFile.getAbsolutePath().isEmpty()) {
					try(Scanner readFile = new Scanner(dataFile)){
						while (readFile.hasNextLine()){
							String lineOfInput = readFile.nextLine();
							//System.out.println(lineOfInput);
							indexWords(index,lineOfInput);
						}
					}
				...
				listOfFilesWithIndex.put(index,file);
